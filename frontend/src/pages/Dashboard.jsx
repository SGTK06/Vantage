...
export default function Dashboard() {
  ...
  const handleParse = async () => {
    ...
    try {
      ...
      setParsedData(data)
      // Refresh categories in case new ones were automatically generated by Gemma
  ...
  const handleCreateCustomCategory = async (e) => {
    ...
    try {
      const created = await apiCreateCategory(newCatName.trim(), newCatDesc.trim())
      setCategorySuccess(`Category "${created.name}" created with embedding.`)
      setNewCatName('')
      setNewCatDesc('')
      await fetchCategories()
    } catch (err) {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '60vh' }}>
            <div className="wb-card" style={{ width: '100%', maxWidth: '520px', padding: '2.25rem' }}>
              <div style={{ marginBottom: '1.75rem' }}>
                ...
                <p className="wb-subtitle">Upload your invoice PDF to extract structured data via LlamaParse OCR and auto-categorize with Google AI.</p>
              </div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
              <div>
                ...
                <p className="wb-subtitle">Overview of parsed, categorized, and recorded vendor invoices.</p>
              </div>
              <button
                type="button"
        ...
        {/* Product Categories Management Modal */}
        {isCategoryModalOpen && (
          <div className="wb-modal-overlay" onClick={() => setIsCategoryModalOpen(false)}>
            <div className="wb-modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '640px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.5rem' }}>
                ...
                <button type="button" onClick={() => setIsCategoryModalOpen(false)} className="wb-button-ghost">
                  Close
                </button>
              </div>

              {/* Add category form */}
              <form onSubmit={handleCreateCustomCategory} style={{ background: 'var(--surface-hover)', padding: '1.25rem', borderRadius: '6px', marginBottom: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                  ...
                  />
                  {categoryError && <div className="wb-alert-error">{categoryError}</div>}
                  {categorySuccess && <div className="wb-alert-success">{categorySuccess}</div>}
                  <button
                    type="submit"
                  ...
                  >
                    {isCreatingCategory ? 'Generating Embedding...' : '+ Add Category'}
                  </button>
                </div>
              </form>
              ...
              <div>
                <h3 style={{ fontSize: '0.875rem', fontWeight: 600, marginBottom: '0.75rem' }}>Existing Categories ({categories.length})</h3>
                {categories.length > 0 ? (
                ...
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.5rem' }}>
                    <div>
                      ...
                      <p className="wb-subtitle">Review invoice details and AI-classified product categories from <strong>{file?.name}</strong>.</p>
                    </div>
